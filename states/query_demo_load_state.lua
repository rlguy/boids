local query_demo_load = state:new()
...
--      INPUT
--[[----------------------------------------------------------------------]]--
function query_demo_load.keypressed(key)
end
function query_demo_load.keyreleased(key)
end
function query_demo_load.mousepressed(x, y, button)
end
function query_demo_load.mousereleased(x, y, button)
end
...
--[[----------------------------------------------------------------------]]--
--##########################################################################--
function query_demo_load.load(str)
...
function query_demo_load.initialize_audio(level)
end

function query_demo_load.initialize_camera(level)
...
function query_demo_load.construct_level_map(level)
  -- colours
...
function query_demo_load.pre_level_load(level)
...
function query_demo_load.initialize_player(level)
end
function query_demo_load.initialize_tile_explosions(level)
end
function query_demo_load.initialize_cube_shard_set(level)
end
function query_demo_load.initialize_shard_sets(level)
end
function query_demo_load.initialize_mouse_input(level)
  level:set_mouse(MOUSE_INPUT)
end
function query_demo_load.initialize_audio_objects(level)
end
function query_demo_load.initialize_polygonizer(level)
...
function query_demo_load.post_level_load(level)
...
--[[----------------------------------------------------------------------]]--
--##########################################################################--
function query_demo_load.update(dt)
...
--[[----------------------------------------------------------------------]]--
--##########################################################################--
function query_demo_load.draw()
  love.graphics.setBackgroundColor(0, 0, 0, 255)
end

return query_demo_load
