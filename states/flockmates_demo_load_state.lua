local flockmates_demo_load = state:new()
...
--      INPUT
--[[----------------------------------------------------------------------]]--
function flockmates_demo_load.keypressed(key)
end
function flockmates_demo_load.keyreleased(key)
end
function flockmates_demo_load.mousepressed(x, y, button)
end
function flockmates_demo_load.mousereleased(x, y, button)
end
...
--[[----------------------------------------------------------------------]]--
--##########################################################################--
function flockmates_demo_load.load(str)
...
function flockmates_demo_load.initialize_audio(level)
end

function flockmates_demo_load.initialize_camera(level)
...
function flockmates_demo_load.construct_level_map(level)
  -- colours
...
function flockmates_demo_load.pre_level_load(level)
...
function flockmates_demo_load.initialize_player(level)
end
function flockmates_demo_load.initialize_tile_explosions(level)
end
function flockmates_demo_load.initialize_cube_shard_set(level)
end
function flockmates_demo_load.initialize_shard_sets(level)
end
function flockmates_demo_load.initialize_mouse_input(level)
  level:set_mouse(MOUSE_INPUT)
end
function flockmates_demo_load.initialize_audio_objects(level)
end
function flockmates_demo_load.initialize_polygonizer(level)
...
function flockmates_demo_load.post_level_load(level)
...
--[[----------------------------------------------------------------------]]--
--##########################################################################--
function flockmates_demo_load.update(dt)
...
--[[----------------------------------------------------------------------]]--
--##########################################################################--
function flockmates_demo_load.draw()
  love.graphics.setBackgroundColor(0, 0, 0, 255)
end

return flockmates_demo_load
