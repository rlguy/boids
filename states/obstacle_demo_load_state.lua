local obstacle_demo_load = state:new()
...
--      INPUT
--[[----------------------------------------------------------------------]]--
function obstacle_demo_load.keypressed(key)
end
function obstacle_demo_load.keyreleased(key)
end
function obstacle_demo_load.mousepressed(x, y, button)
end
function obstacle_demo_load.mousereleased(x, y, button)
end
...
--[[----------------------------------------------------------------------]]--
--##########################################################################--
function obstacle_demo_load.load(str)
...
function obstacle_demo_load.initialize_audio(level)
end

function obstacle_demo_load.initialize_camera(level)
...
function obstacle_demo_load.construct_level_map(level)
  -- colours
...
function obstacle_demo_load.pre_level_load(level)
...
function obstacle_demo_load.initialize_player(level)
end
function obstacle_demo_load.initialize_tile_explosions(level)
end
function obstacle_demo_load.initialize_cube_shard_set(level)
end
function obstacle_demo_load.initialize_shard_sets(level)
end
function obstacle_demo_load.initialize_mouse_input(level)
  level:set_mouse(MOUSE_INPUT)
end
function obstacle_demo_load.initialize_audio_objects(level)
end
function obstacle_demo_load.initialize_polygonizer(level)
...
function obstacle_demo_load.post_level_load(level)
...
--[[----------------------------------------------------------------------]]--
--##########################################################################--
function obstacle_demo_load.update(dt)
...
--[[----------------------------------------------------------------------]]--
--##########################################################################--
function obstacle_demo_load.draw()
  love.graphics.setBackgroundColor(0, 0, 0, 255)
end

return obstacle_demo_load
