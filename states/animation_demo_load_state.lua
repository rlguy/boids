...
--      INPUT
--[[----------------------------------------------------------------------]]--
function animation_demo_load_state.keypressed(key)
end
function animation_demo_load_state.keyreleased(key)
end
function animation_demo_load_state.mousepressed(x, y, button)
end
function animation_demo_load_state.mousereleased(x, y, button)
end
...
--[[----------------------------------------------------------------------]]--
--##########################################################################--
function animation_demo_load_state.load(str)
...
function animation_demo_load_state.initialize_audio(level)
end

function animation_demo_load_state.initialize_camera(level)
...
function animation_demo_load_state.construct_level_map(level)
  -- colours
  ...
  local blend = 0.02
  local g_background = tile_gradient:new(require( dir.."greenyellow"), ncolors)
...
function animation_demo_load_state.pre_level_load(level)
...
function animation_demo_load_state.initialize_player(level)
end
function animation_demo_load_state.initialize_tile_explosions(level)
end
function animation_demo_load_state.initialize_cube_shard_set(level)
end
function animation_demo_load_state.initialize_shard_sets(level)
end
function animation_demo_load_state.initialize_mouse_input(level)
  level:set_mouse(MOUSE_INPUT)
end
function animation_demo_load_state.initialize_audio_objects(level)
end
function animation_demo_load_state.initialize_polygonizer(level)
...
function animation_demo_load_state.post_level_load(level)
...
--[[----------------------------------------------------------------------]]--
--##########################################################################--
function animation_demo_load_state.update(dt)
...
--[[----------------------------------------------------------------------]]--
--##########################################################################--
function animation_demo_load_state.draw()
  love.graphics.setBackgroundColor(0, 0, 0, 255)
end

return animation_demo_load_state
